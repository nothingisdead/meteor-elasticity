...
Elasticity = function(config) {
	...
	function search(search_type, index_name, search_string, q_options, f_options, type, offset, limit) {
		...
		var promise = new Promise(function(resolve, reject) {
			...
			raw_promise.done(Meteor.bindEnvironment(callback), function(error) {
	...
	function deleteIndex(index_name, options) {
		var promise = new Promise(function(resolve, reject) {
			try{
				var call = client.deleteIndex(index_name, options, function() {
	...
	function addToIndex(index_name, doc, id, options, type, callback) {
		var index = indices[index_name];
		...
		var call = client.index(index_name, type, doc, id, index.options);
